...
diverging <- list(
  ...
  vermelho_turquesa = ramp_lab(
    c(darken("#E50505", 0.35), "#E50505", mid, "#3ACC9F", "#1D7A5D"), 9
  ),
  # Purple <-> green (high hue separation, equal weight)
  roxo_verde = ramp_lab(
    c("#40015B", "#730D9F", mid, "#78BE20", "#5E9428"), 9
  ),
  # Orange <-> purple
  laranja_roxo = ramp_lab(
    c("#996017", "#F89D49", mid, "#9148B0", "#40015B"), 9
  ),
  # Pink <-> green
  rosa_verde = ramp_lab(
    c("#CD2F9A", "#F47DCD", mid, "#92D053", "#5E9428"), 9
  ),
  # Red <-> dark blue (azul) — strong, sober
  vermelho_azul = ramp_lab(
    c(darken("#E50505", 0.3), "#E50505", mid, "#2BA680", "#0E171D"), 9
  )
)

render_swatches(
  diverging, "data-raw/refs/proto_diverging.png",
...
render_swatches(
  muted, "data-raw/refs/proto_muted.png",
